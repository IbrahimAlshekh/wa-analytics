...
export default function InsightsPanel({ entries }) {
    ...
    if (!hasPresence)
        return null;
    return (_jsxs("div", { className: "col", style: { gap: 16 }, children: [_jsxs("div", { className: "card", style: { padding: "12px 16px" }, children: [_jsx("div", { className: "muted", style: { fontSize: 11, marginBottom: 8, textTransform: "uppercase", letterSpacing: 1 }, children: "Presence" }), _jsxs("div", { className: "stats", style: { marginBottom: 0 }, children: [avgSession != null && _jsx(StatCard, { label: "Avg session", value: formatDuration(avgSession) }), longestSess != null && _jsx(StatCard, { label: "Longest session", value: formatDuration(longestSess) }), avgOnlineSec != null && _jsx(StatCard, { label: "Daily avg online", value: formatDuration(avgOnlineSec) + (trendPct != null ? `  ${trendPct > 0 ? "▲" : "▼"}${Math.abs(trendPct)}%` : "") }), streak != null && _jsx(StatCard, { label: streak.online ? "Online streak" : "Offline for", value: streak.online ? `${streak.days}d` : formatDuration(streak.seconds) }), longestOffline != null && _jsx(StatCard, { label: "Longest offline streak", value: `${longestOffline}d` }), nightOwlPct != null && _jsx(StatCard, { label: "Night owl", value: `${nightOwlPct}%` }), consistency != null && _jsx(StatCard, { label: "Consistency", value: `${consistency}/100` })] })] }), (avgResponse != null || sentPerDay != null || ghostRate != null) && (_jsxs("div", { className: "card", style: { padding: "12px 16px" }, children: [_jsx("div", { className: "muted", style: { fontSize: 11, marginBottom: 8, textTransform: "uppercase", letterSpacing: 1 }, children: "Conversation" }), _jsxs("div", { className: "stats", style: { marginBottom: 0 }, children: [avgResponse != null && _jsx(StatCard, { label: "Avg response time", value: formatDuration(avgResponse) }), sentPerDay != null && _jsx(StatCard, { label: "Msgs sent / day", value: sentPerDay.toFixed(1) }), receivedPerDay != null && _jsx(StatCard, { label: "Msgs recv / day", value: receivedPerDay.toFixed(1) }), ghostRate != null && _jsx(StatCard, { label: "Ghost rate", value: `${ghostRate}%` }), initiatorPct != null && _jsx(StatCard, { label: "You initiated", value: `${initiatorPct}%` }), avgConvLen != null && _jsx(StatCard, { label: "Avg conv length", value: `${avgConvLen} msgs` }), doubleTextPct != null && _jsx(StatCard, { label: "They double-text", value: `${doubleTextPct}%` }), mediaRatio != null && _jsx(StatCard, { label: "Media ratio", value: `${mediaRatio}%` }), picFreqDays != null && _jsx(StatCard, { label: "Pic changes", value: `every ${picFreqDays}d` })] })] })), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }, children: [patternSummary && (_jsxs("div", { className: "card", style: { padding: "12px 16px" }, children: [_jsx("div", { className: "muted", style: { fontSize: 11 }, children: "Peak hours" }), _jsx("div", { style: { marginTop: 4, fontWeight: 600, color: "var(--accent)" }, children: patternSummary })] })), sleepWindow && (_jsxs("div", { className: "card", style: { padding: "12px 16px" }, children: [_jsx("div", { className: "muted", style: { fontSize: 11 }, children: "Sleep window (est.)" }), _jsx("div", { style: { marginTop: 4, fontWeight: 600 }, children: sleepWindow })] })), firstSeen && (_jsxs("div", { className: "card", style: { padding: "12px 16px" }, children: [_jsx("div", { className: "muted", style: { fontSize: 11 }, children: "Tracking period" }), _jsxs("div", { style: { marginTop: 4, fontSize: 13 }, children: [_jsx("span", { children: formatDate(firstSeen) }), _jsx("span", { className: "muted", children: " \u2192 " }), _jsx("span", { children: formatDate(lastSeen) })] })] }))] }), heatmapData.length > 0 && (_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "Activity Heatmap" }), _jsx("div", { className: "muted", style: { marginBottom: 12 }, children: "Daily online time \u2014 last 16 weeks" }), _jsx(Heatmap, { data: heatmapData })] })), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }, children: [_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "Peak Activity Hours" }), _jsx("div", { className: "muted", style: { marginBottom: 8 }, children: "Online minutes by hour" }), _jsx("div", { style: { width: "100%", height: 180 }, children: _jsx(ResponsiveContainer, { children: _jsxs(BarChart, { data: hourlyData, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "rgba(127,127,127,0.2)" }), _jsx(XAxis, { dataKey: "hour", tick: { fontSize: 10 } }), _jsx(YAxis, { tick: { fontSize: 10 } }), _jsx(Tooltip, {}), _jsx(Bar, { dataKey: "minutes", fill: "var(--accent)" })] }) }) })] }), _jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "Most Active Days" }), _jsx("div", { className: "muted", style: { marginBottom: 8 }, children: "Online minutes by weekday" }), _jsx("div", { style: { width: "100%", height: 180 }, children: _jsx(ResponsiveContainer, { children: _jsxs(BarChart, { data: weekdayData, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "rgba(127,127,127,0.2)" }), _jsx(XAxis, { dataKey: "day", tick: { fontSize: 10 } }), _jsx(YAxis, { tick: { fontSize: 10 } }), _jsx(Tooltip, {}), _jsx(Bar, { dataKey: "minutes", children: weekdayData.map((d, i) => (_jsx(Cell, { fill: d.weekend ? "var(--offline)" : "var(--accent)" }, i))) })] }) }) })] }), trend30.length > 1 && (_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "30-Day Online Trend" }), _jsx("div", { className: "muted", style: { marginBottom: 8 }, children: "Online minutes per day" }), _jsx("div", { style: { width: "100%", height: 180 }, children: _jsx(ResponsiveContainer, { children: _jsxs(LineChart, { data: trend30, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "rgba(127,127,127,0.2)" }), _jsx(XAxis, { dataKey: "date", tick: { fontSize: 10 } }), _jsx(YAxis, { tick: { fontSize: 10 } }), _jsx(Tooltip, {}), _jsx(Line, { type: "monotone", dataKey: "minutes", stroke: "var(--accent)", dot: false, strokeWidth: 2 })] }) }) })] })), msgHourData.some((d) => d.count > 0) && (_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "Peak Messaging Hours" }), _jsx("div", { className: "muted", style: { marginBottom: 8 }, children: "Messages sent by hour" }), _jsx("div", { style: { width: "100%", height: 180 }, children: _jsx(ResponsiveContainer, { children: _jsxs(BarChart, { data: msgHourData, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "rgba(127,127,127,0.2)" }), _jsx(XAxis, { dataKey: "hour", tick: { fontSize: 10 } }), _jsx(YAxis, { tick: { fontSize: 10 } }), _jsx(Tooltip, {}), _jsx(Bar, { dataKey: "count", fill: "var(--accent)" })] }) }) })] }))] }), msgFreqData.length > 0 && (_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "Message Frequency" }), _jsx("div", { className: "muted", style: { marginBottom: 8 }, children: "Messages per day \u2014 sent vs received" }), _jsx("div", { style: { width: "100%", height: 180 }, children: _jsx(ResponsiveContainer, { children: _jsxs(BarChart, { data: msgFreqData, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "rgba(127,127,127,0.2)" }), _jsx(XAxis, { dataKey: "date", tick: { fontSize: 10 } }), _jsx(YAxis, { tick: { fontSize: 10 } }), _jsx(Tooltip, {}), _jsx(Bar, { dataKey: "sent", fill: "var(--accent)", name: "Sent" }), _jsx(Bar, { dataKey: "received", fill: "var(--offline)", name: "Received" })] }) }) })] })), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }, children: [_jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "About History" }), aboutHistory.length === 0 ? (_jsx("div", { className: "muted", children: "No about changes recorded." })) : (_jsx("div", { className: "col", style: { gap: 8, maxHeight: 220, overflowY: "auto" }, children: aboutHistory.map((e, i) => (_jsxs("div", { style: { borderBottom: "1px solid var(--border)", paddingBottom: 6 }, children: [_jsx("div", { className: "muted", style: { fontSize: 11, marginBottom: 2 }, children: formatDatetime(e.at) }), _jsx("div", { style: { fontSize: 13 }, children: e.text || _jsx("em", { className: "muted", children: "(empty)" }) })] }, i))) }))] }), _jsxs("div", { className: "card", children: [_jsx("h3", { style: { marginTop: 0 }, children: "Profile Picture History" }), pictureHistory.length === 0 ? (_jsx("div", { className: "muted", children: "No profile pictures recorded." })) : (_jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, maxHeight: 220, overflowY: "auto" }, children: pictureHistory.map((e, i) => (_jsxs("a", { href: e.url, target: "_blank", rel: "noreferrer", style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }, children: [_jsx("img", { src: e.url, alt: formatDatetime(e.at), style: { width: 60, height: 60, objectFit: "cover", borderRadius: 8, border: "1px solid var(--border)" } }), _jsx("span", { className: "muted", style: { fontSize: 10 }, children: formatDate(e.at) })] }, i))) }))] })] }), _jsx("div", { style: { display: "flex", justifyContent: "flex-end" }, children: _jsx("button", { className: "btn", onClick: () => exportCSV(entries), children: "Export CSV" }) })] }));
}
// ---------------------------------------------------------------------------
// Sub-components
