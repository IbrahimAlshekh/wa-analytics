...
import type { MonthRow } from "@/types/analytics";
          ...
          <thead>
            <tr>
              {[
                {
                  key: "month",
                  label: t("analytics.monthly.month"),
                  align: "left",
                },
                {
                  key: "you",
                  label: t("analytics.monthly.you"),
                  align: "right",
                },
                { key: "them", label: contactName, align: "right" },
                {
                  key: "total",
                  label: t("analytics.monthly.total"),
                  align: "right",
                },
                {
                  key: "yourPct",
                  label: t("analytics.monthly.yourPct"),
                  align: "right",
                },
              ].map((h) => (
                <th
