...
export default function VolumeCard({ me, them, contactName }: VolumeCardProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="pt-0">
        <BalanceBar
          mePct={meBar}
          meLabel={t("analytics.volume.youPct", {
            pct: me.sharePct.toFixed(1),
          })}
          themLabel={t("analytics.volume.themPct", {
            name: contactName,
            pct: them.sharePct.toFixed(1),
          })}
        />
